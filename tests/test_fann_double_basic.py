...
class TestNetworkCreation:
    ...
    def test_create_network(self):
        ...
        assert isinstance(net, FannNetworkDouble)
    ...
    def test_invalid_dimensions(self):
        ...
        with pytest.raises(ValueError, match="must be positive"):
            FannNetworkDouble([0, 3, 1])
        with pytest.raises(ValueError, match="must be positive"):
            FannNetworkDouble([2, 0, 1])
        with pytest.raises(ValueError, match="must be positive"):
            FannNetworkDouble([2, 3, 0])
        with pytest.raises(ValueError, match="must be positive"):
            FannNetworkDouble([-1, 3, 1])
    ...
    def test_sparse_network(self):
        ...
        net = FannNetworkDouble([2, 8, 1], connection_rate=0.5)
        ...
        net_full = FannNetworkDouble([2, 8, 1], connection_rate=1.0)
    ...
    def test_invalid_connection_rate(self):
        ...
        net = FannNetworkDouble([2, 3, 1], connection_rate=2.0)
        assert net.layers == [2, 3, 1]
...
class TestPrediction:
    ...
    def test_predict_with_float64_array(self):
        """Test prediction with float64 array."""
        net = FannNetworkDouble([2, 3, 1])
...
class TestAdditionalFeatures:
    """Test FannNetworkDouble-specific features."""
    ...
    def test_copy(self):
        ...
        # Copy it
        net_copy = net.copy()
        assert isinstance(net_copy, FannNetworkDouble)
